...
public class MembersList {
    ...
    public static void juniorMembers() throws IOException {
    ...
    public static void seniorMembers() throws IOException {
    ...
    public static void adultMembers() throws IOException {
    ...
    public static void passiveMembers() throws IOException {
    ...
    public static void competitiveJuniorMembers() throws IOException {
    ...
    public static void competitiveAdultMembers() throws IOException {
